...
export default function LoginContentWrapper({ studioName }: { studioName: string }) {
  return (
    <Suspense>
      <LoginContent studioName={studioName} />
    </Suspense>
  );
}

function LoginContent({ studioName }: { studioName: string }) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        {/* ── Opción C: Dúo esquinas — logos fantasma ── */}
        {/* Top-left */}
        <div
          className="absolute pointer-events-none select-none opacity-[0.042]"
          style={{ top: "-140px", left: "-140px", width: "540px", height: "540px", transform: "rotate(-22deg)" }}
        >
        ...
        {/* Bottom-right */}
        <div
          className="absolute pointer-events-none select-none opacity-[0.035]"
      ...
      <div className="w-full max-w-sm space-y-4 relative">
        ...
        <div className="text-center flex flex-col items-center">
          ...
          <p className="text-xs text-muted-foreground/50 mt-1.5 font-semibold tracking-[0.25em] uppercase">
            Gestión Musical Privada
          </p>
        </div>
        ...
        <p className="text-center text-[11px] text-muted-foreground/30">
          {studioName} · Gestión Musical Privada
        </p>
      </div>
    </div>
  );
